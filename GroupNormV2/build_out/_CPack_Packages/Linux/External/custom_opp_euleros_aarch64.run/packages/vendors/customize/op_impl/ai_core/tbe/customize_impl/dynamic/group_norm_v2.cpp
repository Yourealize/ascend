...
template<typename DTYPE> class KernelGroupNormV2{
    ...
    public:
        ...
        __aicore__ inline void Init(GM_ADDR x, GM_ADDR gamma, GM_ADDR beta, GM_ADDR y, GM_ADDR mean, GM_ADDR rstd,float epsilon,
            ...
            //     globalBufferIndex = bigCoreBlockNum*this->tileDataNum * GetBlockIdx();
            ...
            //     globalBufferIndex = tailBlockNum *bigCoreBlockNum*this->tileDataNum
            //                         + (GetBlockIdx() - tailBlockNum)*this->tileDataNum*smallCoreBlockNum;
